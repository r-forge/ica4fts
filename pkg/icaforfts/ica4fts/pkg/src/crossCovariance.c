/**Cross covariance version B. Takes in matrix W and Vector N. Vector N specifies which lags to take, the entries 
must be of type int and in ascending order. Calculates the cross Covariance and outputs all values in matrix.*/
#include <R.h>
