...
/**Modified version. Perform calculation of theta2w and transpose outside. So input will be W (transposed theta2w instead of T angles)*/


SEXP objectiveHC(SEXP W, SEXP E, SEXP N, SEXP C, SEXP PH){
	...
	SEXP H; 
	PROTECT(H= Huber(S,&c)); //Huber transform 		PROTECT 4
